...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=33a8458c783b0be9182cad63b6b6600f&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code">
        <li class="kakao"></li>
      </a>
      <li class="naver"></li>
