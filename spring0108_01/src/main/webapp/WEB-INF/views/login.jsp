...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=fce8d17d057b27b2d9d6e0aae0801c12&redirect_uri=http://localhost:8000/kakao/oauth">
        <li class="kakao"></li>
      </a>
      <li class="naver"></li>
