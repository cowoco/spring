...
<html>
	...
	<body>
	  ...
	  <div>
	   <h1>회원정보보기</h1>
		   <form name="vfrm" action="doMUpdate">
		   <table>
		     <colgroup>
		       <col width="20%">
		       <col width="80%">
		     ...
		     <tr>
		       <th>아이디</th>
		       <td><input type="text" name="id" id="id" value="${mdto.id}"></td>
		     </tr>
		     <tr>
		       <th>패스워드</th>
		     ...
		     <tr>
		       <th>이름</th>
		       <td><input type="text" name="name" id="name" value="${mdto.name}" readonly></td>
		     </tr>
		     <tr>
		       <th>전화번호</th>
		     ...
		     <tr>
		       <th>성별</th>
		       <td><input type="text" name="gender" id="gender" value="${mdto.gender}"></td>
		     </tr>
		     <tr>
		       <th>취미</th>
		       <td><input type="text" name="hobby" id="hobby" value="${mdto.hobby}"></td>
		     </tr>
		   </table>
		   </form>
