	...
	<body>
		...
		<table>
		   <colgroup>
			...
			<c:forEach var="empDeptDto" items="${list}">
			  <tr>
			 	 <!--사원테이블정보 -->
				  <td>${empDeptDto.empDto.employee_id}</td>
				  <td>${empDeptDto.empDto.emp_name}</td>
				  <td>${empDeptDto.empDto.email}</td>
				  <td>${empDeptDto.empDto.hire_date}</td>
				  <td>${empDeptDto.empDto.salary}</td>
				  <td>${empDeptDto.empDto.department_id}</td>
				  
				  <td>${empDeptDto.deptDto.department_id}</td>
				  <td>${empDeptDto.deptDto.department_name}</td>
				  <td>${empDeptDto.deptDto.parent_id}</td>
				  <td>${empDeptDto.deptDto.create_date}</td>
