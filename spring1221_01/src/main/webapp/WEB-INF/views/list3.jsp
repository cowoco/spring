		...
		<table>
		   <colgroup>
			...
			<c:forEach var="memBoardDto" items="${list}">
			  <tr>
			 	 <!--사원테이블정보 -->
				  <td>${memBoardDto.memDto.id}</td>
				  <td>${memBoardDto.memDto.pw}</td>
				  <td>${memBoardDto.memDto.name}</td>
				  <td>${memBoardDto.memDto.phone}</td>
				  <td>${memBoardDto.memDto.gender}</td>
				  <td>${memBoardDto.memDto.hobby}</td>
