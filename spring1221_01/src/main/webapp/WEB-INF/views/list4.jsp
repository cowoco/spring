	...
	<body>
		...
		<table>
		   <colgroup>
			...
			<c:forEach var="mbDto" items="${list1}">
			  <tr>
			 	 <!--사원테이블정보 -->
				  <td>${mbDto.memDto.id}</td>
				  <td>${mbDto.memDto.pw}</td>
				  <td>${mbDto.memDto.name}</td>
				  <td>${mbDto.memDto.phone}</td>
				  <td>${mbDto.memDto.gender}</td>
				  <td>${mbDto.memDto.hobby}</td>
				  
				  <td>${mbDto.boardDto.bno}</td>
				  <td>${mbDto.boardDto.btitle}</td>
				  <td>${mbDto.boardDto.id}</td>
				  <td>${mbDto.boardDto.bdate}</td>
