				...
				<fieldset class="fieldset_class">
					...
					<dl id="join_id_dl">
						...
						<dd>
							...
							<input type="button" id="idChekBtn" value="중복확인"/>
							<span id="chkTxt">4~16자리의 영문, 숫자, 특수기호(_)만 사용하실 수 있습니다.</span>
					...
					<dl id="join_pw1_dl">
						...
						<dd>
							...
							<span id="pwTxt1">영문, 숫자, 특수문자 중 2종류 조합 시 10자리 이상 입력</span>
							<span id="pwTxt2">영문, 숫자, 특수문자 모두 조합 시 8자리 이상 입력</span>
						</dd>
					</dl>
					<dl id="join_pw2_dl">
						<dt>
