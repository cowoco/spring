			...
			<div id="contents">
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="day">
								...
								<fmt:formatDate value="${map.bdto.bdate}" pattern="yyyy-MM-dd" /> </span>
							</div>
						</div>

						<div class="viewContents">${map.bdto.bcontent}
						<br><br>
					...
					<div class="replyBox">
						...
						<!--
						<ul>
							<li class="name">tamong <span>[2014-03-04&nbsp;&nbsp;15:01:59]</span></li>
					...
					<div class="btnArea btline">
						<div class="bRight">
							...
							<li><a href="#" class="nbtnbig">댓글</a></li>
