...
public class MController {
	...
	@GetMapping("idsearch") //아이디 찾기 페이지 열기
	public String idsearch() {
		return "member/idsearch";
	}
	
	@PostMapping("idsearch") //ajax 아이디 찾기 - name,email
	@ResponseBody
	...
	public String IdCheck(MemberDto2 mdto2) {
		System.out.println("MController IdCheck id : "+mdto2.getId());
		
		String result = mService.IdCheck(mdto2);
