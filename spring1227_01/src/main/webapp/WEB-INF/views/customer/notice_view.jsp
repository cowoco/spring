				...
				<div id="customer">
					...
					<script>
					 	$(function(){
					 		...
					 		$(document).on("click",".updateBtn",function(){
					 			...
					 			//alert("아이디와 날짜 :"+$(this).parent().prev().prev().text());
					 			...
					 			let hdata = '';
					 			 ...
					 			 hdata += '<a  class="rebtn cancelBtn" style="cursor: pointer;">취소</a>&nbsp';					 			 
					 			 hdata += '</li>';					 			 
					 		
					 			$("#"+cno).html(hdata); //html삭제 후(초기화 후) 추가
					 			 temp=1; //수정창이 열려있음.
					...
					<div class="replyBox">
						...
						<ul>
							...
							<li class="btn">
								<a href="#" class="saveBtn" style="cursor: pointer;>수정</a>
								<a href="#" class="cancelBtn" style="cursor: pointer;>삭제</a>
							</li>
						</ul>
