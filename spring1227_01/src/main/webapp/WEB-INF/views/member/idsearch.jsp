			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								<li><input type="text" name="name" id="idName" class="nameType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='nameType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								<li><input type="text" name="email" id="idEmail" class="emailType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='emailType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>
					...
					<div class="informbox">
						<div class="inform">
							...
							<div class="btn"><a id="pwBtn" class="gbtn c_pionter" >비밀번호 찾기</a></div>
						</div>
					</div>
