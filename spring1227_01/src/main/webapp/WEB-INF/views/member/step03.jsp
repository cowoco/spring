						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<script>
								$(function(){
									$(".sbtnMini").click(()=>{
										...
										//{}는 자리수를 의미함.
										//let idpattern =/^[*&^%]{4,16}$/; 
										let idpattern =/^[a-zA-Z0-9]{4,16}$/;
										let id2pattern =/^[a-z]{1}[a-zA-Z0-9]{2,9}$/; //3-10자리
										let pwpattern=/^(?=.*[a-zA-Z])(?=.*[0-9])(?=.*[!@#$%^&*()_+].{3,})$/;
										...
										if(!idpattern.test(id)){
											alert("3-10자리 영문자 또는 숫자만 사용 가능합니다.");
											return false;
										}
									...
									//-----------------------------------------------------
										...
										if(pw==pw2){
											$("#pwIncon").addClass("black");
											$("#pwIncon").removeClass("orange");
											$("#pwIncon").text("비밀번호가 일치 합니다." );
											
											
										}else{
											$("#pwIncon").text("비밀번호가 일치하지 않습니다." );
											$("#pwIncon").addClass("orange");
											$("#pwIncon").removeClass("black");
										}
							...
							<form action="/member/step04" name="frm" method="post">
								<tr>
									...
									<td><li class="r10"><input type="text" id="name" name="name" class="w134" /></li></td>
								</tr>
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li>
												...
												<span id="pwIncon" class="mvalign"></span>
											</li>
										</ul>
									</td>
								</tr>
									...
									<td>
										<ul class="pta">
											<li>
												<ul class="baseQues">
													<li>
														<input type="checkbox" name="hobby" id="game" value="" class="radio_t" checked="checked"/><label for="game">게임</label>
													</li>
													<li>
														<input type="checkbox" name="hobby" id="golf" value=""  class="radio_t"/><label for="golf">골프</label>
													</li>
													<li>
														<input type="checkbox" name="hobby" id="run" value=""  class="radio_t" /><label for="run">달리기</label>
													</li>
													<li>
														<input type="checkbox" name="hobby" id="cook" value=""  class="radio_t" /><label for="cook">요리</label>
													</li>
													<li>
														<input type="checkbox" name="hobby" id="book" value=""  class="radio_t" /><label for="book">책</label>
													</li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li>
												<input type="text" class="w134" id="zipcode" name="zipcode"/>&nbsp;
											</li>
